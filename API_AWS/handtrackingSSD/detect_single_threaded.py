...
def main(image):
    ...
    boxes, scores = detector_utils.detect_objects(image,
    ...
    #                                  image_np, 0.75)
    (p1x, p1y, p2x, p2y), image_display = detector_utils.get_image_cropped(num_hands_detect, 0.2,
                                        scores, boxes, len(image[0]), len(image),
                                        image, 0.4)
    print(333)
    ...
    #         break
    #     out_path = os.path.abspath(os.getcwd()) +   '/API_AWS/cropped_images'
